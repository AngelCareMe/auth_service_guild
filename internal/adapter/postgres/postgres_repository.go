...
type PostgresRepository interface {
	...
	SaveBlizzardUser(ctx context.Context, userID int, battletag string) error
	SaveBlizzardToken(ctx context.Context, userID string, blizzardID int, token *entity.BlizzardToken) error
